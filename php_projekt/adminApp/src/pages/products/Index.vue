    ...
    >
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td key="deleted_at" :props="props">
          <span>{{ props.row.deleted_at }}</span>
        </q-td>
    ...
    export default {
        data() {
            return {
                columns: [
                    ...
                    {name: 'deleted_at', label: 'Deleted At', field: 'deleted_at', sortable: true, align: 'left'},
        ...
        methods: {
            request({pagination}) {
                ...
                this.loading = true
                // document.getElementById("demo").innerHTML = `http://127.0.0.1:8000/api/products/list/${pagination.page}?rowsPerPage=${pagination.rowsPerPage}&sortBy=${pagination.sortBy}&descending=${pagination.descending}`
                // fetch data
                axios
